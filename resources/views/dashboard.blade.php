...
@section('content')
    ...
    <div class="bg-green-100 py-14">
      ...
      <h4 class="text-center font-thin text-xl mt-14">Create Your Own Blog :  <a href="{{route('blog.index')}}" class="underline text-gray-600 cursor-pointer">Click Here</a></h4>
    </div>
</section>
@endsection
